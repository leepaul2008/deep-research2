...
- **无前导零**：`1` 非 `01`，`2.1` 非 `02.01`
- **无前缀**：无 `ch-` `q-` `R1-` 等字母前缀
- **只在 `id` 字段使用**：最终报告中不出现任何编号

来源：ISO 2145:1978 ([iso.org](https://www.iso.org/standard/6937.html)), GB/T 1.1-2020 ([openstd.samr.gov.cn](https://openstd.samr.gov.cn/bzgk/std/newGbInfo?hcno=C4BFD981E993C417EF475F2A19B681F1))
