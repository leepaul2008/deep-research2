...
```text
请调研 https://github.com/hoolulu/deep-research 项目，自动安装前置依赖并适配 CLI 工具：
...
| 组件                                   | 用途                                       | 获取方式                                                                   |
| ------------------------------------ | ---------------------------------------- | ---------------------------------------------------------------------- |
| **OpenCode**                         | AI 编码 agent 运行时                          | `curl -fsSL https://opencode.ai/install | bash` |
...
```text
请对比 https://github.com/hoolulu/deep-research 最新版与本地版本的差异，找出上游新增功能和修复，逐项应用到本地适配版本中，保留平台特定改动。
```
