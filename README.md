...
👉 **[浏览所有已生成的案例报告](案例报告/)** — 点此浏览所有已生成的调研报告，可直接点击打开阅读。
...
- **命令**：输入 `/research-update`，AI 自动对比本地和远程版本号，如有更新则执行 `git pull`
...
`/research-update` 如果你之前安装的时候有建立此命令。

或者更简单，你可以让 AI 帮你做版本对比和更新适配。把下面这段提示词粘贴到你的 AI 编码工具中：
